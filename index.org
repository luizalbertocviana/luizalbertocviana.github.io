...
Você pode consultar meu Lattes em http://lattes.cnpq.br/2028165237751191

Você pode visitar o repositorio deste site [[https://github.com/luizalbertocviana/luizalbertocviana.github.io][aqui]].
...
* Outros trabalhos
** Resumos Estendidos e Pôsteres
   - *SBPO 2019* Um Modelo de Programação Inteira Aplicado ao Problema
...
** Repositórios
   - [[https://github.com/luizalbertocviana/cracking-coding-problems][cracking-coding-problems]] contém soluções para os problemas
     propostos pelo livro Cracking the Coding Interview, em C++.
   - [[https://github.com/luizalbertocviana/data-structures-cpp][data-structures-cpp]] é uma coleção de estruturas de dados
     clássicas, implementadas em C++ com fins didáticos.
   - [[https://github.com/luizalbertocviana/dotfiles][dotfiles]] contém o setup do meu ambiente de trabalho. Destaque
     para as configurações do Emacs e i3wm.
   - [[https://github.com/luizalbertocviana/lisp-experiments][lisp-experiments]] é uma coleção de códigos-fonte escritos em
     Common Lisp. Genérico, com o propósito de aprender a linguagem.
** Slides
   - Uma apresentação sobre C++ moderno: [[file:slides/cpp.pdf][pdf]] [[file:slides/cpp.tex][tex]]
...
** Estrutura de Dados
   ...
   - notas de aula gentilmente cedidas por [[alex]]: [[file:ed/document.pdf][pdf]] 
** Estrutura de Dados Avançada
   - semestres: 2020.1
   - notas de aula: [[https://github.com/luiz-classrooms/eda-lecture-notes][repsitório]]
...
** Matemática Computacional
   ...
   - notas de aula: [[https://github.com/luiz-classrooms/mc-lecture-notes][repositório]]
** Matemática Discreta
   - semestres: 2016.2
** Programação Funcional
   - semestres: 2017.1, 2018.1, 2019.1
   - notas de aula: [[https://github.com/luiz-classrooms/pf-lecture-notes][repositório]]
